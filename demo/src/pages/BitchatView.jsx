...
import { Warning, CheckCircle, ArrowUp, Bluetooth } from '@phosphor-icons/react'
import { incident } from '../data/incident'

export default function BitchatView() {
    ...
    <div className="min-h-screen flex items-center justify-center">
      ...
      <div className="content-layer flex flex-col items-center gap-6">
        ...
        <div className="w-full flex items-center justify-between">
          <span className="text-[11px] text-foreground-muted">Apple Watch · 45mm · Mesh delivery</span>
        ...
        <p className="text-body-s text-foreground-muted text-center max-w-[260px]">
          Same alert experience — push failed, so it arrived via BLE mesh relay from a nearby teammate's device.
        </p>
      </div>
    </div>
  )
