...
const activeInvestigations = [
  ...
  {
    id: 'INV-1023',
    title: 'Lambda cold start increase after deploy',
    status: 'in-progress',
    started: '2h ago',
    findings: 5,
    severity: 'medium',
  ...
  {
    id: 'INV-1021',
    title: 'DynamoDB throttling in order-service',
    status: 'resolved',
    started: 'Yesterday',
    findings: 7,
    severity: 'high',
...
const aiSuggestions = [
  {
    title: 'Correlate checkout errors with DB latency',
    description: 'I noticed checkout-service 5xx errors spike when DynamoDB read latency exceeds 50ms. Want me to build a correlation view?',
  },
  {
    title: 'Compare pre/post deploy metrics',
    description: 'payment-service was deployed 4 hours ago. I can compare key metrics before and after to identify regressions.',
  },
]
