...
const CHAT_RESPONSES = {
  ...
  'slo': {
    text: <><p>I can create a p99 latency SLO for order-service:</p><div className="mt-1.5 p-2 rounded-lg bg-background-surface-2/50 space-y-1"><div className="flex justify-between"><span className="text-foreground-muted">Service</span><span className="text-foreground">order-service</span></div><div className="flex justify-between"><span className="text-foreground-muted">Metric</span><span className="text-foreground">p99 Latency</span></div><div className="flex justify-between"><span className="text-foreground-muted">Target</span><span className="text-foreground">&lt; 300ms</span></div><div className="flex justify-between"><span className="text-foreground-muted">Window</span><span className="text-foreground">30-day rolling</span></div><div className="flex justify-between"><span className="text-foreground-muted">Burn rate alert</span><span className="text-foreground">2× for 1h, 10× for 5m</span></div></div><p className="mt-1.5 text-foreground-muted">This would have triggered 18 min before today's alarm. Based on 30 days of baseline data.</p></>,
    followUps: ['Create this SLO', 'Adjust the threshold', 'Add SLOs for other services'],
  },
  'set up': {
